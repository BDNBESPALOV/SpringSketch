...
import com.bdn.spring.controller.MainController;
...
@Sql(value = {"/create-user-before.sql","/messages-lost-before.sql"}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
@Sql(value = {"/messages-lost-after.sql","/create-user-after.sql"}, executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
@WithUserDetails(value = "BDN")
public class MainControllerTest {
    ...
    public void mainPageTest() throws Exception {
        this.mockMvc.perform(get("/main"))
                ...
                .andExpect(xpath("//*[@id=\"navbarSupportedContent\"]/form[1]/div").string("BDN"));
    }
    @Test
